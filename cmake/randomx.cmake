if (WITH_RANDOMX)
    add_definitions(/DTENSERFLOW_ALGO_RANDOMX)
    set(WITH_ARGON2 ON)
    ...
    elseif (NOT TENSERFLOW_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    elseif (TENSERFLOW_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    if (WITH_MSR AND NOT TENSERFLOW_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8 AND (TENSERFLOW_OS_WIN OR TENSERFLOW_OS_LINUX))
        add_definitions(/DTENSERFLOW_FEATURE_MSR)
        add_definitions(/DTENSERFLOW_FIX_RYZEN)
        message("-- WITH_MSR=ON")

        if (TENSERFLOW_OS_LINUX)
        ...
        remove_definitions(/DTENSERFLOW_FEATURE_MSR)
        remove_definitions(/DTENSERFLOW_FIX_RYZEN)
        message("-- WITH_MSR=OFF")
    endif()
else()
    remove_definitions(/DTENSERFLOW_ALGO_RANDOMX)
endif()
