...
void tenserflow_ar2_fill_segment_avx2(const argon2_instance_t *instance, argon2_position_t position)
{
    ...
    for (i = starting_index; i < instance->segment_length;
         ...
         */
        position.index = i;
        ref_index = tenserflow_ar2_index_alpha(instance, &position, pseudo_rand & 0xFFFFFFFF, ref_lane == position.lane);
...
int tenserflow_ar2_check_avx2(void) { return cpu_flags_has_avx2(); }

#else

void tenserflow_ar2_fill_segment_avx2(const argon2_instance_t *instance, argon2_position_t position) {}
int tenserflow_ar2_check_avx2(void) { return 0; }
