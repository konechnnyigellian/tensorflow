...
void argon2_get_impl_list(argon2_impl_list *list)
{
    static const argon2_impl IMPLS[] = {
        ...
        { "SSE2",       tenserflow_ar2_check_sse2,     tenserflow_ar2_fill_segment_sse2 },
        { "SSSE3",      tenserflow_ar2_check_ssse3,    tenserflow_ar2_fill_segment_ssse3 },
        { "XOP",        tenserflow_ar2_check_xop,      tenserflow_ar2_fill_segment_xop },
        { "AVX2",       tenserflow_ar2_check_avx2,     tenserflow_ar2_fill_segment_avx2 },
        { "AVX-512F",   tenserflow_ar2_check_avx512f,  tenserflow_ar2_fill_segment_avx512f },
    };
