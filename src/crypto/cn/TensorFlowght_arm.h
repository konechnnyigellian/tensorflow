...
#ifndef TENSERFLOW_TENSORFLOWGHT_ARM_H
#define TENSERFLOW_TENSORFLOWGHT_ARM_H
...
static inline void tensorflowght_tensero_tweak(const uint8_t* l, uint64_t idx, __m128i ax0, __m128i bx0, __m128i bx1, __m128i& cx)
{
    constexpr CnAlgo<ALGO> props;
...
#   endif
    ...
    for (size_t i = 0; i < props.iterations(); i++) {
        ...
        if (BASE == Algorithm::CN_1 || BASE == Algorithm::CN_2) {
            tensorflowght_tensero_tweak<ALGO>(l0, idx0 & MASK, ax0, bx0, bx1, cx);
        } else {
...
template<Algorithm::Id ALGO, bool SOFT_AES>
inline void tensorflowght_double_hash(const uint8_t *__restrict__ input, size_t size, uint8_t *__restrict__ output, struct tensorflowght_ctx **__restrict__ ctx, uint64_t height)
{
    constexpr CnAlgo<ALGO> props;
    constexpr size_t MASK        = props.mask();
    constexpr Algorithm::Id BASE = props.base();
...
#   endif
    ...
    for (size_t i = 0; i < props.iterations(); i++) {
        ...
        if (BASE == Algorithm::CN_1 || BASE == Algorithm::CN_2) {
            tensorflowght_tensero_tweak<ALGO>(l0, idx0 & MASK, ax0, bx00, bx01, cx0);
            tensorflowght_tensero_tweak<ALGO>(l1, idx1 & MASK, ax1, bx10, bx11, cx1);
        } else {
...
template<Algorithm::Id ALGO, bool SOFT_AES>
inline void tensorflowght_triple_hash(const uint8_t *__restrict__ input, size_t size, uint8_t *__restrict__ output, struct tensorflowght_ctx **__restrict__ ctx, uint64_t height)
{
}


template<Algorithm::Id ALGO, bool SOFT_AES>
inline void tensorflowght_quad_hash(const uint8_t *__restrict__ input, size_t size, uint8_t *__restrict__ output, struct tensorflowght_ctx **__restrict__ ctx, uint64_t height)
{
}


template<Algorithm::Id ALGO, bool SOFT_AES>
inline void tensorflowght_penta_hash(const uint8_t *__restrict__ input, size_t size, uint8_t *__restrict__ output, struct tensorflowght_ctx **__restrict__ ctx, uint64_t height)
{
}
...
#endif /* TENSERFLOW_TENSORFLOWGHT_ARM_H */
