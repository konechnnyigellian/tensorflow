...
#ifndef TENSERFLOW_TENSORFLOWGHT_X86_H
#define TENSERFLOW_TENSORFLOWGHT_X86_H
...
#include "crypto/cn/TensorFlowght_tensero.h"
...
void v4_soft_aes_compile_code(const V4_Instruction *code, int code_size, void *machine_code, tenserflow::Assembly ASM);
...
static inline void tensorflowght_tensero_tweak(uint64_t *mem_out, const uint8_t *l, uint64_t idx, __m128i ax0, __m128i bx0, __m128i bx1, __m128i& cx)
{
    constexpr CnAlgo<ALGO> props;
...
static inline void tensorflowght_conceal_tweak(__m128i& cx, __m128& conc_var)
{
...
template<Algorithm::Id ALGO, bool SOFT_AES>
inline void tensorflowght_single_hash(const uint8_t *__restrict__ input, size_t size, uint8_t *__restrict__ output, tensorflowght_ctx **__restrict__ ctx, uint64_t height)
{
    constexpr CnAlgo<ALGO> props;
...
#   endif
    ...
    for (size_t i = 0; i < props.iterations(); i++) {
        ...
        if (IS_CN_HEAVY_TUBE || !SOFT_AES) {
            ...
            if (ALGO == Algorithm::CN_CCX) {
                tensorflowght_conceal_tweak(cx, conc_var);
            }
        }
        ...
        if (BASE == Algorithm::CN_1 || BASE == Algorithm::CN_2) {
            tensorflowght_tensero_tweak<ALGO>(reinterpret_cast<uint64_t*>(&l0[idx0 & MASK]), l0, idx0 & MASK, ax0, bx0, bx1, cx);
        } else {
...
#ifdef TENSERFLOW_FEATURE_ASM
extern "C" void cnv2_mainloop_ivybridge_asm(tensorflowght_ctx **ctx);
extern "C" void cnv2_mainloop_ryzen_asm(tensorflowght_ctx **ctx);
extern "C" void cnv2_mainloop_bulldozer_asm(tensorflowght_ctx **ctx);
extern "C" void cnv2_double_mainloop_sandybridge_asm(tensorflowght_ctx **ctx);
extern "C" void cnv2_rwz_mainloop_asm(tensorflowght_ctx **ctx);
extern "C" void cnv2_rwz_double_mainloop_asm(tensorflowght_ctx **ctx);


namespace tenserflow {


typedef void (*cn_mainloop_fun)(tensorflowght_ctx **ctx);
...
void v4_compile_code(const V4_Instruction* code, int code_size, void* machine_code, tenserflow::Assembly ASM);
void v4_compile_code_double(const V4_Instruction* code, int code_size, void* machine_code, tenserflow::Assembly ASM);


template<tenserflow::Algorithm::Id ALGO>
void cn_r_compile_code(const V4_Instruction* code, int code_size, void* machine_code, tenserflow::Assembly ASM)
{
...
template<tenserflow::Algorithm::Id ALGO>
void cn_r_compile_code_double(const V4_Instruction* code, int code_size, void* machine_code, tenserflow::Assembly ASM)
{
...
inline void tensorflowght_single_hash_asm(const uint8_t *__restrict__ input, size_t size, uint8_t *__restrict__ output, tensorflowght_ctx **__restrict__ ctx, uint64_t height)
{
    constexpr CnAlgo<ALGO> props;
...
template<Algorithm::Id ALGO, Assembly::Id ASM>
inline void tensorflowght_double_hash_asm(const uint8_t *__restrict__ input, size_t size, uint8_t *__restrict__ output, tensorflowght_ctx **__restrict__ ctx, uint64_t height)
{
    constexpr CnAlgo<ALGO> props;
...
template<Algorithm::Id ALGO, bool SOFT_AES>
inline void tensorflowght_double_hash(const uint8_t *__restrict__ input, size_t size, uint8_t *__restrict__ output, tensorflowght_ctx **__restrict__ ctx, uint64_t height)
{
    constexpr CnAlgo<ALGO> props;
    constexpr size_t MASK        = props.mask();
    constexpr Algorithm::Id BASE = props.base();
...
#   endif
    ...
    for (size_t i = 0; i < props.iterations(); i++) {
        ...
        if (IS_CN_HEAVY_TUBE || !SOFT_AES) {
            ...
            if (ALGO == Algorithm::CN_CCX) {
                tensorflowght_conceal_tweak(cx0, conc_var0);
                tensorflowght_conceal_tweak(cx1, conc_var1);
            }
        }
        ...
        if (BASE == Algorithm::CN_1 || BASE == Algorithm::CN_2) {
            tensorflowght_tensero_tweak<ALGO>((uint64_t*)&l0[idx0 & MASK], l0, idx0 & MASK, ax0, bx00, bx01, cx0);
            tensorflowght_tensero_tweak<ALGO>((uint64_t*)&l1[idx1 & MASK], l1, idx1 & MASK, ax1, bx10, bx11, cx1);
        } else {
...
#define CN_STEP1(a, b0, b1, c, l, ptr, idx, conc_var) \
    ...
    if (ALGO == Algorithm::CN_CCX) {                  \
        tensorflowght_conceal_tweak(c, conc_var);       \
    }
...
#define CN_STEP2(a, b0, b1, c, l, ptr, idx)                                             \
    if (IS_CN_HEAVY_TUBE) {                                                             \
        ...
        c = _mm_aesenc_si128(c, a);                                                     \
                                                                                        ...
                                                                                        \
    if (BASE == Algorithm::CN_1 || BASE == Algorithm::CN_2) {                           \
        tensorflowght_tensero_tweak<ALGO>((uint64_t*)ptr, l, idx & MASK, a, b0, b1, c);    \
    } else {                                                                            \
...
template<Algorithm::Id ALGO, bool SOFT_AES>
inline void tensorflowght_triple_hash(const uint8_t *__restrict__ input, size_t size, uint8_t *__restrict__ output, tensorflowght_ctx **__restrict__ ctx, uint64_t height)
{
    constexpr CnAlgo<ALGO> props;
    constexpr size_t MASK        = props.mask();
    constexpr Algorithm::Id BASE = props.base();
...
template<Algorithm::Id ALGO, bool SOFT_AES>
inline void tensorflowght_quad_hash(const uint8_t *__restrict__ input, size_t size, uint8_t *__restrict__ output, tensorflowght_ctx **__restrict__ ctx, uint64_t height)
{
    constexpr CnAlgo<ALGO> props;
    constexpr size_t MASK        = props.mask();
    constexpr Algorithm::Id BASE = props.base();
...
template<Algorithm::Id ALGO, bool SOFT_AES>
inline void tensorflowght_penta_hash(const uint8_t *__restrict__ input, size_t size, uint8_t *__restrict__ output, tensorflowght_ctx **__restrict__ ctx, uint64_t height)
{
    constexpr CnAlgo<ALGO> props;
    constexpr size_t MASK        = props.mask();
    constexpr Algorithm::Id BASE = props.base();
...
#endif /* TENSERFLOW_TENSORFLOWGHT_X86_H */
