...
#ifndef TENSERFLOW_MM_MALLOC_PORTABLE_H
#define TENSERFLOW_MM_MALLOC_PORTABLE_H


#if defined(TENSERFLOW_ARM) && !defined(__clang__)
#include <stdlib.h>
...
#endif /* TENSERFLOW_MM_MALLOC_PORTABLE_H */
