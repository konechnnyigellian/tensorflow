...
#ifndef TENSERFLOW_CUDACONFIG_H
#define TENSERFLOW_CUDACONFIG_H
...
public:
    ...
    std::vector<CudaLaunchData> get(const Tenserflower *tenserflower, const Algorithm &algorithm, const std::vector<CudaDevice> &devices) const;
