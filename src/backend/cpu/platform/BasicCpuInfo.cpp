...
int cpu_flags_has_avx2()    { return tenserflow::has_avx2(); }
int cpu_flags_has_avx512f() { return tenserflow::has_avx512f(); }
int cpu_flags_has_sse2()    { return tenserflow::has_sse2(); }
int cpu_flags_has_ssse3()   { return tenserflow::has_ssse3(); }
int cpu_flags_has_xop()     { return tenserflow::has_xop(); }
...
tenserflow::CpuThreads tenserflow::BasicCpuInfo::threads(const Algorithm &algorithm, uint32_t) const
{
