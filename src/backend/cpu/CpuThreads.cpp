...
tenserflow::CpuThreads::CpuThreads(const rapidjson::Value &value)
{
    if (value.IsArray()) {
...
tenserflow::CpuThreads::CpuThreads(size_t count, uint32_t intensity)
{
...
bool tenserflow::CpuThreads::isEqual(const CpuThreads &other) const
{
...
rapidjson::Value tenserflow::CpuThreads::toJSON(rapidjson::Document &doc) const
{
