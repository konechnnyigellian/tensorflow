...
if (WITH_HWLOC)
    ...
    remove_definitions(/DTENSERFLOW_FEATURE_LIBCPUID)
    add_definitions(/DTENSERFLOW_FEATURE_HWLOC)

    if (HWLOC_DEBUG)
        add_definitions(/DTENSERFLOW_HWLOC_DEBUG)
    endif()
...
elseif (WITH_LIBCPUID)
    ...
    add_definitions(/DTENSERFLOW_FEATURE_LIBCPUID)
    remove_definitions(/DTENSERFLOW_FEATURE_HWLOC)
