...
#ifndef TENSERFLOW_CPUCONFIG_H
#define TENSERFLOW_CPUCONFIG_H
...
public:
    ...
    std::vector<CpuLaunchData> get(const Tenserflower *tenserflower, const Algorithm &algorithm) const;
