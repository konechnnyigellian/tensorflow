if (BUILD_STATIC AND TENSERFLOW_OS_UNIX AND WITH_OPENCL)
...
if (WITH_OPENCL)
    ...
    add_definitions(/DTENSERFLOW_FEATURE_OPENCL)
    ...
    if (WITH_STRICT_CACHE)
        add_definitions(/DTENSERFLOW_STRICT_OPENCL_CACHE)
    else()
        remove_definitions(/DTENSERFLOW_STRICT_OPENCL_CACHE)
    endif()

    if (WITH_INTERLEAVE_DEBUG_LOG)
        add_definitions(/DTENSERFLOW_INTERLEAVE_DEBUG)
    endif()

    if (WITH_ADL AND (TENSERFLOW_OS_WIN OR TENSERFLOW_OS_LINUX))
        add_definitions(/DTENSERFLOW_FEATURE_ADL)
       ...
       remove_definitions(/DTENSERFLOW_FEATURE_ADL)
    endif()
else()
    remove_definitions(/DTENSERFLOW_FEATURE_OPENCL)
    remove_definitions(/DTENSERFLOW_FEATURE_ADL)
