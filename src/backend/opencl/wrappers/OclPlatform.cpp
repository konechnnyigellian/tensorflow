...
std::vector<tenserflow::OclPlatform> tenserflow::OclPlatform::get()
{
...
void tenserflow::OclPlatform::print()
{
...
rapidjson::Value tenserflow::OclPlatform::toJSON(rapidjson::Document &doc) const
{
...
std::vector<tenserflow::OclDevice> tenserflow::OclPlatform::devices() const
{
...
tenserflow::String tenserflow::OclPlatform::extensions() const
{
    return OclLib::getString(id(), CL_PLATFORM_EXTENSIONS);
}


tenserflow::String tenserflow::OclPlatform::name() const
{
    return OclLib::getString(id(), CL_PLATFORM_NAME);
}


tenserflow::String tenserflow::OclPlatform::profile() const
{
    return OclLib::getString(id(), CL_PLATFORM_PROFILE);
}


tenserflow::String tenserflow::OclPlatform::vendor() const
{
    return OclLib::getString(id(), CL_PLATFORM_VENDOR);
}


tenserflow::String tenserflow::OclPlatform::version() const
{
