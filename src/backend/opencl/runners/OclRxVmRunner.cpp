...
tenserflow::OclRxVmRunner::OclRxVmRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


tenserflow::OclRxVmRunner::~OclRxVmRunner()
{
    delete m_init_vm;
    delete m_execute_vm;
...
size_t tenserflow::OclRxVmRunner::bufferSize() const
{
    return OclRxBaseRunner::bufferSize() + (align(2560 * m_intensity));
}


void tenserflow::OclRxVmRunner::build()
{
...
void tenserflow::OclRxVmRunner::execute(uint32_t iteration)
{
...
void tenserflow::OclRxVmRunner::init()
{
