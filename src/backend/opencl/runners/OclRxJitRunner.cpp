...
tenserflow::OclRxJitRunner::OclRxJitRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


tenserflow::OclRxJitRunner::~OclRxJitRunner()
{
...
void tenserflow::OclRxJitRunner::execute(uint32_t iteration)
{
...
void tenserflow::OclRxJitRunner::init()
{
...
bool tenserflow::OclRxJitRunner::loadAsmProgram()
{
