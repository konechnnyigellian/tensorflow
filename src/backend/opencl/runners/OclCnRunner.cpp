...
tenserflow::OclCnRunner::OclCnRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
tenserflow::OclCnRunner::~OclCnRunner()
{
    delete m_cn0;
    delete m_cn1;
    delete m_cn2;
...
size_t tenserflow::OclCnRunner::bufferSize() const
{
...
void tenserflow::OclCnRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void tenserflow::OclCnRunner::set(const Job &job, uint8_t *blob)
{
...
void tenserflow::OclCnRunner::build()
{
    OclBaseRunner::build();
...
void tenserflow::OclCnRunner::init()
{
    OclBaseRunner::init();
