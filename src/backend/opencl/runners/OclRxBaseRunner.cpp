...
tenserflow::OclRxBaseRunner::OclRxBaseRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
tenserflow::OclRxBaseRunner::~OclRxBaseRunner()
{
...
void tenserflow::OclRxBaseRunner::run(uint32_t nonce, uint32_t *hashOutput)
{
...
void tenserflow::OclRxBaseRunner::set(const Job &job, uint8_t *blob)
{
...
size_t tenserflow::OclRxBaseRunner::bufferSize() const
{
...
void tenserflow::OclRxBaseRunner::build()
{
    OclBaseRunner::build();
...
void tenserflow::OclRxBaseRunner::init()
{
    OclBaseRunner::init();
