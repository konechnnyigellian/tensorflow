...
#ifndef TENSERFLOW_LOG_H
#define TENSERFLOW_LOG_H
...
#define LOG_EMERG(x, ...)   tenserflow::Log::print(tenserflow::Log::EMERG,   x, ##__VA_ARGS__)
#define LOG_ALERT(x, ...)   tenserflow::Log::print(tenserflow::Log::ALERT,   x, ##__VA_ARGS__)
#define LOG_CRIT(x, ...)    tenserflow::Log::print(tenserflow::Log::CRIT,    x, ##__VA_ARGS__)
#define LOG_ERR(x, ...)     tenserflow::Log::print(tenserflow::Log::ERR,     x, ##__VA_ARGS__)
#define LOG_WARN(x, ...)    tenserflow::Log::print(tenserflow::Log::WARNING, x, ##__VA_ARGS__)
#define LOG_NOTICE(x, ...)  tenserflow::Log::print(tenserflow::Log::NOTICE,  x, ##__VA_ARGS__)
#define LOG_INFO(x, ...)    tenserflow::Log::print(tenserflow::Log::INFO,    x, ##__VA_ARGS__)
#define LOG_VERBOSE(x, ...) if (tenserflow::Log::verbose() > 0) { tenserflow::Log::print(tenserflow::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V1(x, ...)      if (tenserflow::Log::verbose() > 0) { tenserflow::Log::print(tenserflow::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V2(x, ...)      if (tenserflow::Log::verbose() > 1) { tenserflow::Log::print(tenserflow::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V3(x, ...)      if (tenserflow::Log::verbose() > 2) { tenserflow::Log::print(tenserflow::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V4(x, ...)      if (tenserflow::Log::verbose() > 3) { tenserflow::Log::print(tenserflow::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V5(x, ...)      if (tenserflow::Log::verbose() > 4) { tenserflow::Log::print(tenserflow::Log::INFO, x, ##__VA_ARGS__); }

#ifdef APP_DEBUG
#   define LOG_DEBUG(x, ...) tenserflow::Log::print(tenserflow::Log::DEBUG, x, ##__VA_ARGS__)
#else
#   define LOG_DEBUG(x, ...)
#endif

#if defined(APP_DEBUG) || defined(APP_DEVEL)
#   define LOG_DEBUG_ERR(x, ...)  tenserflow::Log::print(tenserflow::Log::ERR,     x, ##__VA_ARGS__)
#   define LOG_DEBUG_WARN(x, ...) tenserflow::Log::print(tenserflow::Log::WARNING, x, ##__VA_ARGS__)
#else
