...
#ifndef TENSERFLOW_ISTRATEGYLISTENER_H
#define TENSERFLOW_ISTRATEGYLISTENER_H
...
{
public:
    TENSERFLOW_DISABLE_COPY_MOVE(IStrategyListener);
...
#endif // TENSERFLOW_ISTRATEGYLISTENER_H
