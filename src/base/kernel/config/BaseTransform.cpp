...
void tenserflow::BaseTransform::load(JsonChain &chain, Process *process, IConfigTransform &transform)
{
...
void tenserflow::BaseTransform::finalize(rapidjson::Document &doc)
{
    using namespace rapidjson;
...
void tenserflow::BaseTransform::transform(rapidjson::Document &doc, int key, const char *arg)
{
    switch (key) {
...
void tenserflow::BaseTransform::transformBoolean(rapidjson::Document &doc, int key, bool enable)
{
    switch (key) {
    case IConfig::BackgroundKey: /* --background */
...
void tenserflow::BaseTransform::transformUint64(rapidjson::Document &doc, int key, uint64_t arg)
{
    switch (key) {
    case IConfig::RetriesKey: /* --retries */
