...
#ifndef TENSERFLOW_SELFSELECTCLIENT_H
#define TENSERFLOW_SELFSELECTCLIENT_H
...
{
public:
    TENSERFLOW_DISABLE_COPY_MOVE_DEFAULT(SelfSelectClient)
...
#endif /* TENSERFLOW_SELFSELECTCLIENT_H */
