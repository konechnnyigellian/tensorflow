...
#ifndef TENSERFLOW_FAILOVERSTRATEGY_H
#define TENSERFLOW_FAILOVERSTRATEGY_H
...
{
public:
    TENSERFLOW_DISABLE_COPY_MOVE_DEFAULT(FailoverStrategy)
...
#endif /* TENSERFLOW_FAILOVERSTRATEGY_H */
