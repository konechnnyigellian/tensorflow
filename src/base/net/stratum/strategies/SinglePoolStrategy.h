...
#ifndef TENSERFLOW_SINGLEPOOLSTRATEGY_H
#define TENSERFLOW_SINGLEPOOLSTRATEGY_H
...
{
public:
    TENSERFLOW_DISABLE_COPY_MOVE_DEFAULT(SinglePoolStrategy)
...
#endif /* TENSERFLOW_SINGLEPOOLSTRATEGY_H */
