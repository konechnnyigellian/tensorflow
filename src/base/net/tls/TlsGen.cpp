...
void tenserflow::TlsGen::generate(const char *commonName)
{
...
bool tenserflow::TlsGen::generate_x509(const char *commonName)
{
    m_x509 = X509_new();
    if (!m_x509) {
        return false;
