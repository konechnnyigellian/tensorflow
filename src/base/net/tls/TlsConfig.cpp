 ...
 */
tenserflow::TlsConfig::TlsConfig(const rapidjson::Value &value)
{
    if (value.IsObject()) {
...
bool tenserflow::TlsConfig::generate(const char *commonName)
{
    TlsGen gen;
...
rapidjson::Value tenserflow::TlsConfig::toJSON(rapidjson::Document &doc) const
{
...
void tenserflow::TlsConfig::setProtocols(const char *protocols)
{
...
void tenserflow::TlsConfig::setProtocols(const rapidjson::Value &protocols)
{
    m_protocols = 0;
