...
#ifndef TENSERFLOW_STRING_H
#define TENSERFLOW_STRING_H
 ...
 * 2. For some reason I prefer don't use std:string in tenserflower, eg because of file size of MSYS2 builds.
