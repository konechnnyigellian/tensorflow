...
#ifndef TENSERFLOW_PROFILER_H
#define TENSERFLOW_PROFILER_H
...
#else /* TENSERFLOW_FEATURE_PROFILING */
#define PROFILE_SCOPE(x)
#endif /* TENSERFLOW_FEATURE_PROFILING */
