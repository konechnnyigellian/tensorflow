...
void tenserflow::Api::request(const HttpData &req)
{
...
void tenserflow::Api::onConfigChanged(Config *config, Config *previousConfig)
{
...
void tenserflow::Api::exec(IApiRequest &request)
{
    using namespace rapidjson;
...
#       endif
#       ifdef TENSERFLOW_FEATURE_LIBCPUID
...
void tenserflow::Api::genId(const String &id)
{
...
void tenserflow::Api::genWorkerId(const String &id)
{
