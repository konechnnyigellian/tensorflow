...
if (WITH_HTTP)
    ...
    add_definitions(/DTENSERFLOW_FEATURE_HTTP)
    add_definitions(/DTENSERFLOW_FEATURE_API)
else()
    set(HEADERS_BASE_HTTP "")
    set(SOURCES_BASE_HTTP "")
    remove_definitions(/DTENSERFLOW_FEATURE_HTTP)
    remove_definitions(/DTENSERFLOW_FEATURE_API)
endif()
...
if (WITH_ENV_VARS)
    add_definitions(/DTENSERFLOW_FEATURE_ENV)
else()
    remove_definitions(/DTENSERFLOW_FEATURE_ENV)
endif()
...
if (WITH_PROFILING)
    add_definitions(/DTENSERFLOW_FEATURE_PROFILING)
